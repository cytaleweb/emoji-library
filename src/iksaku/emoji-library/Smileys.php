...
class Smileys {
    ...
    const SLIGHT_SMILE = "\u{1F642}";
    const UPSIDE_DOWN = "\u{1F643}";
    const WINK = "\u{1F609}";
    ...
    const MONEY_MOUTH = "\u{1F911}";
    const HUGGING = "\u{1F917}";
    const NERD = "\u{1F913}";
    ...
    const SLIGHT_FROWN = "\u{1F641}";
    const FROWNING2 = "\u{2639}";
    ...
    const MASK = "\u{1F637}";
    const THERMOMETER_FACE = "\u{1F912}";
    const HEAD_BANDAGE = "\u{1F915}";
